          ...
          >
            <CardHeader className="pb-4 p-6 md:p-8">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <CardTitle className="text-lg md:text-xl font-black text-white italic truncate">{doctor.name}</CardTitle>
            ...
            <CardContent className="space-y-4 p-6 md:p-8 pt-0">
              ...
              <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                <div>
                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] mb-0.5">Honoraires</p>
                    <p className="text-lg font-black text-white italic">Libre <span className="text-[10px] text-primary not-italic font-medium ml-1">(voir avec Dr)</span></p>
                </div>
                <Badge className="bg-primary/10 text-primary border-none text-[9px] font-black uppercase px-3 py-1 rounded-full flex items-center gap-1">
