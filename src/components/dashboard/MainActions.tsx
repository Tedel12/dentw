        ...
        <Card className="h-full relative overflow-hidden group hover:shadow-2xl transition-all duration-500 border-2 hover:border-primary/50 shadow-sm bg-background">
          ...
          <CardContent className="relative p-8 flex flex-col h-full">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-xl font-black mb-1">Assistant vocal IA</h3>
                <p className="text-sm text-muted-foreground">Conseils dentaires par appels vocaux</p>
              </div>
            </div>
            ...
            <div className="space-y-4 flex-1">
              ...
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-primary rounded-full group-hover:scale-150 transition-transform duration-300"></div>
                <span className="text-sm font-medium">Conseils pour soulager la douleur</span>
              </div>
            </div>
            ...
            <Link
              ...
              className={buttonVariants({
                variant: "default",
                className:
                  "w-full mt-6 bg-primary hover:bg-primary/90 text-white font-bold py-6 rounded-2xl shadow-lg hover:shadow-primary/20 transition-all duration-300 group-hover:-translate-y-1",
              })}
            >
